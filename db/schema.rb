...
ActiveRecord::Schema[8.0].define(version: 2025_08_31_124229) do
  ...
  create_table "permitted_routes", force: :cascade do |t|
    ...
    t.index ["carrier", "origin_iata", "destination_iata"], name: "idx_on_carrier_origin_iata_destination_iata_0e51fa02f9"
  end
  ...
  create_table "segments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["airline", "origin_iata", "destination_iata"], name: "index_segments_on_airline_and_origin_iata_and_destination_iata"
  end
end
